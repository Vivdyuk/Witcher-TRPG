function getAllItems() {
  return {
    ...
    'Бойова сокира': new Weapon('Бойова сокира', 'Р', 'Зв', 0, '5d6', 15, 1, '-', '', 'К', 0, 2, 525),
    ...
    'Ручний арбалет': new Weapon('Ручний арбалет', 'K', 'У', 1, '2d6 + 2', 5, 1, '50 м', 'Повільна перезарядка', 'К', 1, 0.5, 285),
    ...
    'Арбалетні болти': new Ammo('Арбалетні болти', 'К', 'З', 10, '', 'K', 0.3, 10),
    ...
    'Двошаровий гамбезон': new Armor('Двошаровий гамбезон', 8, 'Р', 1, '', 0, 2.5, 250),
    'Посилені штані': new Armor('Посилені штані', 12, 'З', 0, '', 0, 3.5, 250),
    ...
    /** Tools */
    'Грабіжницькі інструменти': new Tool('Грабіжницькі інструменти', 'Дозволяють відкривати замки', 'P', 'M', 1, 80),
    'Інструменти алхіміка': new Tool('Інструменти алхіміка', 'Дозволяють створювати алхімічні сполуки', 'P', 'K', 3, 80),
    'Хірургічні інструменти': new Tool('Хірургічні інструменти', 'Дозволяють проводити хірургічні операції', 'Зв', 'H', 1, 80),
    'Інструменти торговця': new Tool('Інструменти торговця', '+2 до Торгівлі при оцінці товару', 'Зв', 'Н', 1.5, 60),
    'Інструменти ремісника': new Tool('Інструменти ремісника', 'Дозволяють створювати зброю та броню', 'Зв', 'К', 5, 83),
    'Набір для макіяжу': new Tool('Набір для макіяжу', '+2 до Зваблення і Харизми', 'З', 'M', 0.5, 35),
    'Похідна кузня': new Tool('Похідна кузня', 'Дозволяє створбвати зброю і броню будь-де', 'P', 'K', 5, 111),
    'Письмовий інвентар': new Tool('Письмовий інвентар', 'Дозволяє писати письма, записки тощо', 'З', 'H', 1, 25),
    ...
    'Формула олії': new Item('Формула олії', 0, 0, 'NO INFO'),
    'Формула відвару': new Item('', 0, 0, 'NO INFO'),
    'Корд': new Item('Корд', 0, 0, 'NO INFO'),
    'Відьмачий медальйон': new Item('Відьмачий медальйон', 0, 0, 'NO INFO'),
